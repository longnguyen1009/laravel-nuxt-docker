  ...
  <footer class="border-t lg:border-gray-900/10 dark:border-gray-50/[0.2]">
    ...
    >
      <div class="w-full py-4 text-center md:text-left">
        <div class="mb-1">Nuxt 3 Awesome Starter</div>
        <div class="text-xs text-gray-600 dark:text-gray-400">
          Copyright © 2022 <a href="https://github.com/longnguyen1009">longnguyen1009</a
          ...
          >
            <span class="text-center md:text-right">
              design by <a href="https://github.com/longnguyen1009">longnguyen1009</a>
            </span>
            <span
